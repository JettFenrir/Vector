...
epilog="""
tool for a Website made by Abhijeet, Sameer, Shantanu and Aakanksha
"""
def check(getopt):
...
def start():
	parse=argparse.ArgumentParser(formatter_class=argparse.RawTextHelpFormatter,usage="xsshunter -u <target> [options]",epilog=epilog,add_help=False)
